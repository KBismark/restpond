...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className="inline-flex h-10 items-center justify-start rounded-none bg-transparent p-0 text-slate-500"
    {...props}
  />
))
