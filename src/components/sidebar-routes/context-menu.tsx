      ...
      > */}
        ...
        <Menu>
          <MenuItem>
            {({ active }) => (
              <button
                className={`${active ? 'bg-white' : ''} flex w-full items-center px-3 py-2 text-sm hover:bg-white/70 rounded-md transition-all duration-300`}
                onClick={onRename}
              >
          ...
          <MenuItem>
            {({ active }) => (
              <button
                className={`${active ? 'bg-gray-100' : ''} flex w-full items-center px-3 py-2 text-sm text-red-600 hover:bg-white/70 rounded-md transition-all duration-300`}
                onClick={onDelete}
              >
